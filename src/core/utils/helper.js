...
export const missionAndVisionData = [
  {
    title: "Our Mission",
    description:
      "To enhance the business growth of our customers with creative Design and Development to deliver market-defining high-quality solutions that create value and consistent competitive advantage for our clients around the Country.",
    icon: <BiRocket style={{ fontSize: "30px", color: "white" }} />,
  },
  {
    title: "Our Vision",
    description:
      "To become a prime performer, in providing quality Web, Print and Software solutions in the competitive Local market place.",
...
export const termsAndConditionsData = [
  {
    ...
    description: (
      <span>
        ...
        agreement with and bound by the terms of services contained in the Terms
        and Conditions outlined below. These terms apply to the entire website
        and any email or other type of communication between you and.
        <br />
        <br /> Under no circumstances shall team be liable for any direct,
        ...
        costs thereof. will not be responsible for any outcome that may occur
  ...
  },
  {
    ...
    description: (
      <span>
        Modern Resolve grants you a revocable, non-exclusive, non-transferable,
        limited license to download, install and use our service strictly in
        accordance with the terms of this Agreement. <br /> <br /> These Terms &
        Conditions are a contract between you and Modern Resolve (referred to in
        these Terms & Conditions as 'Modern Resolve', 'us', 'we' or 'our'), the
        provider of the Modern Resolve website and the services accessible from
        the Modern Resolve website (which are collectively referred to in these
        Terms & Conditions as the 'Modern Resolve Service'). <br /> <br /> You
        are agreeing to be bound by these Terms & Conditions. If you do not
  ...
  },
  {
    ...
    moreInfo: [
      ...
      },
      {
        subDescription: (
          <span>
            ...
            'us,' or 'our,' it refers to Modern Resolve, Calamba City Laguna
      ...
      },
      {
        subDescription: (
          <span>
            <strong>Country: </strong>where Modern Resolve or the
            owners/founders of Modern Resolve are based in this case is
            Philippines.
          </span>
        ),
      },
      {
        subDescription: (
          <span>
            ...
            person that signs up to use the Modern Resolve Service to manage the
      ...
      },
      {
        subDescription: (
          <span>
            ...
            visit Modern Resolve and use the services.
          </span>
        ),
      },
      {
      ...
      },
      {
        subDescription: (
          <span>
            ...
            employed by Modern Resolve or are under contract to perform a
      ...
      },
      {
        subDescription: (
          <span>
            <strong>Service: </strong>refers to the service provided by Modern
            Resolve as described in the relative terms (if available) and on
            this platform.
          </span>
        ),
      },
      ...
      },
      {
        subDescription: (
          <span>
            <strong>Website: </strong>Modern Resolve's site, which can be
            accessed via this URL: modernresolve.com.
          </span>
        ),
      },
      {
        subDescription: (
          <span>
            ...
            Modern Resolve to use the Services.
          </span>
        ),
      },
    ],
  ...
  },
  {
    ...
    description: (
      <span>
        ...
        products.
        <br /> As with any shopping experience, there are terms and conditions
        that apply to transactions at our company. We'll be as brief as our
        ...
        our Privacy Policy
        <br /> If, for any reason, You are not completely satisfied with any
  ...
  },
  {
    ...
    description:
      "We reserve the nght to modify, suspend or discontinue, temporarily or permanently, the service or any service to which it connects, with or without notice and without liability to you.",
    moreInfo: false,
  },
  {
  ...
  },
  {
    ...
    description: (
      <span>
        ...
        and effect. <br />
        <br /> This Agreement, together with the Privacy Policy and any other
        legal notices published by us on the Services, shall constitute the
        entire agreement between you and us concerning the Services. If any
        ...
        AND USAGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
  ...
  },
  {
    ...
    description: (
      <span>
        ...
        waiver of any subsequent breach. <br />
        <br /> No failure to exercise, and no delay in exercising, on the part
  ...
  },
  {
    ...
    description: (
      <span>
        ...
        express or implied. We are a distributor and not a publisher of the
        content supplied by third parties, as such, our exercises no editorial
        ...
        service or merchandise provided through or accessible via our Service.
        Without limiting the foregoing, We specifically disclaim all warranties
        ...
        the products provided as a part of, or otherwise in connection with, our
  ...
  },
  {
    ...
    moreInfo: [
      ...
      },
      {
        subDescription: (
          <span>
            <strong>Via Email: </strong>modernresolve@gmail.com
          </span>
        ),
      },
      {
        subDescription: (
          <span>
            <strong>Via Phone Number: </strong>+63-945-560-2846
          </span>
        ),
      },
      {
        subDescription: (
          <span>
            <strong>Via this Link: </strong>http:/modernresolve.com
          </span>
        ),
      },
    ],
...
export const adminSidebarDataSettingsArea = [
  {
    title: "Our Products",
    dropDown: false,
    // link: "navigateOurProducts",
  },
  {
    title: "Settings",
    dropDown: false,
    link: routerSpiels.router[0].router_obj.admin_settings,
  },
];
