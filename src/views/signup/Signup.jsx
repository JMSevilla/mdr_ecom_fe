...
const Signup = () => {
    const {activeSteps, setActiveSteps,
        ...
        selectedIndex, setSelectedIndex, HandleChangeOnInit} = useContext(GlobalContext)
                                                        ...
                                                        [
                                                            {
                                                                ...
                                                                onChange={(e) => HandleChangeOnInit(
                                                                    e, 
                                                                    'Business', 
                                                                    'firstname',
                                                                    fieldSettings.personalInformationObj,
                                                                    0)}
                                                                variant='outlined'
                                                            ...
                                                            },
                                                            {
                                                                childrenId: 2,
                                                                children : <TextField
                                                                inputProps={{'data-testid' : 'InputBusinessLastname'}}
