...
const rows = [
  createData(1, 'https://media-exp1.licdn.com/dms/image/C4E03AQH67tAH5uO_yw/profile-displayphoto-shrink_800_800/0/1619600525688?e=2147483647&v=beta&t=3u7yPmlJP_5REPpBlx3SZE7C4IbxKY55fxuSGDTqO8g','JM Sevilla', 'Super Admin', 'Software Engineer Lead', 'Active', <AppButton buttonName='View Info' size='small' variant='contained'/>, <AppButton buttonName='inactive' size='small' style={{backgroundColor: 'red', color:'white'}}/> ),
   createData(2, 'https://scontent.fmnl16-1.fna.fbcdn.net/v/t39.30808-6/225686070_2353328224801573_7008311860898386965_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=TrMFf8gKptkAX92QuRn&_nc_ht=scontent.fmnl16-1.fna&oh=00_AT-bPETmSsmX3n8AMj_xQAf--aSzfIxRDI81m6vCFybCfA&oe=63432C4A', 'Bryan Palad', 'Admin', 'Front End Developer', 'Active', <AppButton buttonName='View Info' size='small' variant='contained'/>, <AppButton buttonName='inactive' size='small' style={{backgroundColor: 'red', color:'white'}}/> ),
   createData(3, 'https://scontent.fmnl16-1.fna.fbcdn.net/v/t39.30808-1/263330594_5350444301649337_4848763255940540503_n.jpg?stp=dst-jpg_p200x200&_nc_cat=104&ccb=1-7&_nc_sid=7206a8&_nc_ohc=aISKt6dTSvAAX-xCl2y&_nc_ht=scontent.fmnl16-1.fna&oh=00_AT8WGcxg1Bt7dwBYBmfMhqws8631h92K5LHuJZrj3r7NmQ&oe=63443CAB', 'Cid John Villanueva', 'Admin', 'Front End Developer', 'Active', <AppButton buttonName='View Info' size='small' variant='contained'/>, <AppButton buttonName='inactive' size='small' style={{backgroundColor: 'red', color:'white'}}/> ),
   createData(4, '', 'Cid John Villanueva', 'Admin', 'Front End Developer', 'Active', <AppButton buttonName='View Info' size='small' variant='contained'/>, <AppButton buttonName='inactive' size='small' style={{backgroundColor: 'red', color:'white'}}/> ),
   createData(5, '', 'Cid John Villanueva', 'Admin', 'Front End Developer', 'Active', <AppButton buttonName='View Info' size='small' variant='contained'/>, <AppButton buttonName='inactive' size='small' style={{backgroundColor: 'red', color:'white'}}/> ),
];
